    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td0, file, 23, 4, 479);
    			add_location(td1, file, 24, 4, 500);
    			add_location(td2, file, 25, 4, 518);
    			add_location(td3, file, 26, 4, 545);
    			add_location(td4, file, 27, 4, 572);
    			add_location(tr0, file, 22, 3, 470);
    			add_location(thead, file, 21, 2, 459);
    			add_location(td5, file, 32, 4, 639);
    			add_location(td6, file, 33, 4, 660);
    			add_location(td7, file, 34, 4, 678);
    			add_location(td8, file, 35, 4, 705);
    			add_location(td9, file, 36, 4, 732);
    			add_location(tr1, file, 31, 3, 630);
    			add_location(tbody, file, 30, 5, 619);
    			attr_dev(table, "class", "svelte-ncji4t");
    			add_location(table, file, 20, 1, 449);
    			add_location(main, file, 19, 0, 441);
    		},
